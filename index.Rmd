...
**note: Details on creating packages next month from Karen Blocksum**
...
- Ropensci efforts
  ...
  - [2017 Unconf issue](https://github.com/ropensci/unconf17/issues/5)
]

.right-column[

![gl_figure](g_l_figure.jpg)

** from Gentleman and Lang (2004) **
]
...
---
# Packages to solve our common problems
  - `lakemorpho`
  - `elevatr`
  - `lakescape` (in development)
  
![fixed_it](https://media3.giphy.com/media/ID4NXWnwuLnLq/200.webp#0-grid1)
---
